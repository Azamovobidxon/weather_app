...
final  double? moonphase;
  ...
  factory CurrentConditions.fromJson(Map<String, Object?> json) =>
      CurrentConditions(
        ...
        stations:json["stations"] != null ? List.from(json["stations"] as List) : [] ,
  ...
  @override
  String toString() => 'CurrentConditions(datetime: $datetime,'
...
void main(){
  final curen = CurrentConditions.fromJson(json);
  print(curen);
}