class ApiGeoLocation {
  ...
  @override
  String toString() => 'ApiGeoLocation(ip: $ip, '
...
class TimeZone {
  ...
  factory TimeZone.fromJson(Map<String, Object?> json) => TimeZone(
        ...
        current_time_unix: json["current_time_unix"] as num?,
  ...
  @override
  String toString() => 'TimeZone(name: $name,'
      'offset: $offset,'
...
class CurrencyModel {
  ...
  @override
  String toString() => 'CurrencyModel(code: $code, '
      'name: $name,'
      'symbol: $symbol)';
}
...
final json = {
  ...
  "country_tld": ".uz",
  "languages": "uz,ru,tg",
  "country_flag": "https://ipgeolocation.io/static/flags/uz_64.png",
  "geoname_id": "1513066",
  "isp": "Turon Media XK",
  "connection_type": "",
  "organization": "Turon Media XK",
  "currency": {"code": "UZS", "name": "Uzbekistan Sum", "symbol": "лв"},
  "time_zone": {
    "name": "Asia/Tashkent",
    "offset": 5,
    "offset_with_dst": 5,
    "current_time": "2023-09-18 17:16:58.896+0500",
    "current_time_unix": 1695039418.896,
    "is_dst": false,
    "dst_savings": 0
  }
};
...
void main() {
  final apiGeoLocation = ApiGeoLocation.fromJson(json);
  print(apiGeoLocation);
}
